...
- **Config / resilience:** `AppConfiguration`, `RetryPolicy`, `ResilientExecutor`, smart rate limit, cache (`CacheKey`, `CacheTtlSeconds`).
...
**Poza zakresem (na razie):** moduł CLI (`src/cli/`) — planowana Faza 5a w `brand-types-plan.md`.
