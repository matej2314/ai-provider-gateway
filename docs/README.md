...
18. **Fasady integracji (IDE)** — równoległe API OpenAI i Anthropic nad tym samym `ChatService` (`src/integrations/`); konfiguracja Cursor / Claude Code: `integracje.md`, `integracja-openai-kontrakt.md`, `integracja-anthropic-messages.md`.
...
- `integracja-openai-kontrakt.md` — podłączenie Cursor (Base URL `/api/v1/openai`).
- `integracja-anthropic-messages.md` — podłączenie Claude Code (Base URL `/api/v1/anthropic`).
