...
> Adapter runtime OpenAI (`create-openai-provider.ts` w `src/providers/`) — osobna warstwa; planowany, obecnie niezaimplementowany — [`provider-openai-runtime.md`](provider-openai-runtime.md).  
